...
type CommandStorer interface {
	...
	GetCommandsForRepository(ctx context.Context, repositoryID string) ([]*models.Command, error)
	...
	DeleteCommandRelForRepository(ctx context.Context, commandID string) error
